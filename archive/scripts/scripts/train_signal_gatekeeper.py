...
MODEL_SAVE_PATH = "models/gatekeeper_qnet_v2.pth"
...
# --- TRAINING ENGINE ---
def train():
    logger.info("Loading trajectories v2...")
    ...
    for ep in range(EPISODES):
        ...
        if len(memory) > BATCH_SIZE:
            ...
            # Target is just the reward since it's 1-step
    ...
    with open("models/gatekeeper_scaler_v2.json", "w") as f:
        json.dump(scaler_params, f, indent=4)
    logger.info(f"Scaler params saved to models/gatekeeper_scaler_v2.json")
